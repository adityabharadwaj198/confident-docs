...
Confident AI also offers **DeepEval.ts**, which suuports tracing in Java and Typescript in the form of wrapper functions to easily capture traces in JS/TS-native applications.
...
Consider this tracing example in a TypeScript application (same architecture as the [Python tracing example](/llm-observability/llm-tracing)):
