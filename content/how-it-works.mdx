...
Write or paste in your first prompt on Confident AI's [prompt studio](/prompt-management/introduction). This will allow you to use it for evaluation as well as test it for your use case.
...
LLM tracing is primarily valuable for agentic workflows, where it enables component-level evaluation of complex systems. By implementing [tracing on Confident AI](/llm-tracing/introduction), you can:
