...
<Callout>
  ...
  here](/concepts/datasets#why-shouldnt-goldens-contain-actual_output) to learn
  why.
</Callout>
...
```python showLineNumbers copy {7, 14, 16}
...
Here we pulled the goldens in our dataset from Confident AI by providing an alias, before converting them into test cases dynamically based on the implementation of my LLM application. For more information, [click here.](/dataset-editor/using-datasets)
