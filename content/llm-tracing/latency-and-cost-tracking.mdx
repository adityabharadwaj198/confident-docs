...
| Anthropic | [@anthropic-ai/tokenizer](https://github.com/anthropics/anthropic-tokenizer) | Claude 3 Opus, Claude 3 Sonnet, Claude 3 Haiku | Claude-specific tokenization algorithm |
