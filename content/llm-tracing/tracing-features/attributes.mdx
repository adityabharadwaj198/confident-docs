...
<Tabs items={['Python', 'JS/TypeScript']}>
  ...
  <Tabs.Tab>
    ...
    import { observe, updateCurrentSpanAttributes, RetrieverAttributes } from '@confident/tracing';
...
<Tabs items={['Python', 'JS/TypeScript']}>
  ...
  <Tabs.Tab>
    ...
    import { observe, updateCurrentSpanAttributes } from '@confident/tracing';
