...
Span types are optional and allow you to classify the most common types of components in LLM applications, which includes:
...
<Callout type="info">
Anything that is not one of the four pre-defined span types are automatically custom spans.
</Callout>
