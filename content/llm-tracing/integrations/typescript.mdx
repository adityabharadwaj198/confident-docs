...
- [Optional] `metrics`: An array of strings specifying the names of the online metrics you wish to run upon tracing to Confident AI. Learn more about using online metrics in the [next section here.](/llm-tracing/tracing-features/online-evaluation)
...
For a more detailed walkthrough, please refer to the [video summary above](/llm-tracing/integrations/typescript#code--video-summary).
