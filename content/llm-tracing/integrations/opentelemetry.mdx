...
Confident AI integrates with OpenTelemetry that allows teams to export traces to the **[Observatory](https://documentation.confident-ai.com/llm-observability/overview)** via a Span Exporter.
