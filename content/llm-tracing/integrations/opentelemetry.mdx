...
Confidential AI integrates with OpenTelemetry that allows teams to export traces to the **Observatory** via a Span Exporter.
...
<Callout>
  We encourage the use of [Semantic conventions for generative AI systems](https://opentelemetry.io/docs/specs/semconv/gen-ai/) to ensure that the spans are compatible with the Confidential AI Observability Platform.
</Callout>
