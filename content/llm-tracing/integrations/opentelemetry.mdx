...
<Callout type="info">
  All the OpenTelemetry span's attributes and events are available in the **Confident AI** span's `metadata` property as a fallback.
</Callout>
