...
You can also create **a list of prompt messages**, or which is a list of prompts with the `"role"` and `"content"` field present. If you decide to create a prompt message instead, you can supply it directly to your LLM provider once pulled from Confident AI (more info on this later). More on prompt messages can be [found here.](/prompt-studio/prompt-versioning#create-a-prompt-message-list)
...
> [!TIP]
>
> The entirety of the datasets feature are [available here.](/dataset-editor/overview)
