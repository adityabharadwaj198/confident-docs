...
>
> For more information, on how data is separated and organization is structured, [visit the data handling page.](/data-handling)
...
In the next section, we'll install DeepEval that will be respnosible for running evaluations, which you'll need your API key to login with.
