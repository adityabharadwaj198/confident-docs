...
Navigate to your project, go to the **Datasets** tab on the left navigation drawer. Click on **Create a dataset**, and provide your dataset with an alias. Depending on whether you already have [goldens](/concepts/datasets#goldens), you should either:
