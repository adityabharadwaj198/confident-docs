...
<Callout>
  ...
  section.](/docs/llm-evaluation/running-llm-evals)
</Callout>
...
You can also create test runs on the cloud by running evaluations directly on Confident AI, either using API requests or in a click of a button directly on the platform. [Click here](/docs/llm-evaluation/running-llm-evals#run-llm-evals-on-the-cloud) to learn how.
