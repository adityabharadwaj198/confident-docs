...
You can add custom columns to your dataset to store additional information that doesn't fit into the [default golden fields.](/docs/concepts/datasets#goldens) To add a custom column:
