...
It is extremely common for users to setup cron jobs or pre-deployment [unit-testing evaluations in CI/CD](/llm-evaluation/unit-testing-in-cicd) to create a test run each time a change is made to your LLM application.
