...
It is extremely common for users to setup cron jobs or pre-deployment evaluations to create a test run each time a change is made to your LLM application.
