...
These metrics are available both [via DeepEval](/evaluation/metrics#metrics-via-deepeval) and [on the cloud.](/evaluation/metrics#run-metrics-on-the-cloud)
...
All three custom metrics are available [via DeepEval](/evaluation/metrics#metrics-via-deepeval), only `GEval` is available and [on the cloud.](/evaluation/metrics#run-metrics-on-the-cloud)
...
These metrics are mostly only available [via DeepEval](/evaluation/metrics#metrics-via-deepeval).
